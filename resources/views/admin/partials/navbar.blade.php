            ...
            <div class="dropdown">
                <a class="d-flex align-items-center gap-2 text-white text-decoration-none dropdown-toggle"
                    ...
                    <div class="user-avatar">
                        <img src="{{ auth()->user()?->profile_photo ? asset(auth()->user()->profile_photo) : asset('admin/dist/assets/images/logo/userlogo.webp') }}"
                            alt="{{ auth()->user()->name ?? 'User' }}" class="user-avatar-img">
                    </div>
