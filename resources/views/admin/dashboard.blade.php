        ...
        <section class="row justify-content-center">
            ...
            <div class="col-12">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <a href="{{ route('admin.todayUploads') }}" target="_blank" rel="noopener"
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <a href="{{ route('admin.expiredShares') }}" target="_blank" rel="noopener"
                            class="text-decoration-none">
                ...
                <div class="card shadow-sm border-0 mb-4 admin-users-card">
                    ...
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div>
                                ...
                                <small>Control upload and sharing limits</small>
                            </div>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive admin-users-table-wrap">
                            <table id="usersTable"
                                class="table table-striped table-hover align-middle text-center mb-0 admin-users-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-wrapper">
                                                    ...
                                                    @if ($rowLocked)
                                                        <button type="button"
                                                            class="btn btn-sm admin-action-btn admin-action-locked"
                                                    ...
                                                    <!-- Reset -->
                                                    <form method="POST"
                                                        action="{{ route('admin.users.resetUploads', $user->id) }}">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-sm admin-action-btn admin-action-reset-upload"
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('admin.users.resetShares', $user->id) }}">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-sm admin-action-btn admin-action-reset-share"
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="btn btn-sm admin-action-btn admin-action-delete"
